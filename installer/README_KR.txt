...
- jack.qsp: 5개 UI location 본문을 교체하고, 47개 location의 UI 이미지 경로를 SNKmod 경로로 바꿉니다.
...
- RESTORE.cmd : SNKmod UI를 제거하고 jack.qsp·base.css·menu_icon.json·엔진을 설치 전 상태로 되돌립니다.
...
[예비 리소스]
- ui_map.json에서 Status가 "spare"인 18개 파일은 이 모드에서 쓰지 않습니다.
